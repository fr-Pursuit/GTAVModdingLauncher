...
namespace GTAVModdingLauncher.Ui.Popup
{
	public partial class PopupCustomInstall : ModernWindow
	{
		...
		{
			Launcher.Instance.Config.CustomInstalls.Add(new GTAInstall(this.InstallPath.Text, this.SteamVersion.IsChecked.Value ? InstallType.Steam : InstallType.Retail));
